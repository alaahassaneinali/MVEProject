...
<body>
	...
	<section class="container">
		<form:form  modelAttribute="newShipment" method = "POST" class="form-horizontal" >
			<fieldset>
				<legend>Create Shipment</legend>

				<form:errors path="*" cssClass="alert alert-danger" element="div"/>
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="shipmentNumber"><spring:message code="createShipment.form.shipmentNumber"/></label>
					<div class="col-lg-10">
						<form:input id="shipmentNumber" path="shipmentNumber" type="text" class="form:input-large"/>
