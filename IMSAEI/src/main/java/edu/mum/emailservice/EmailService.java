...
public class EmailService {
  ...
  @Autowired
     ...
     */
  @ServiceActivator()
  public MimeMessage  handle(Shipment shipmentNotice) 
          throws MessagingException {
      
	//  Order order = routeOrder.getOrder();
	  // Need to use your own recipient here
	  String recipientEmail = "eaproject2019@gmail.com";
	  String recipientName = "EA Project";
	  	return handle( recipientName, recipientEmail, shipmentNotice,null);
  
  		}
 
	    public MimeMessage  handle(
	            final String recipientName, final String recipientEmail, Shipment shipmentNotice,Locale locale) 
	            throws MessagingException {
        ...
        thymeContext.setVariable("shipmentNotice", shipmentNotice);
          
        // Prepare message using a Spring helper
        final MimeMessage mimeMessage = this.mailSender.createMimeMessage();
        final MimeMessageHelper message = new MimeMessageHelper(mimeMessage, true,"UTF-8");
        message.setSubject("Shipment Notice Details");
